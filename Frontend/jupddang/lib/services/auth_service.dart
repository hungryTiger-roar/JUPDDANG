...
class AuthService {
  ...
  Future<Map<String, dynamic>> getProfileById(String targetId) =>
      _accountService.getProfileById(targetId);
  ...
  Future<void> deleteComment(String postId, String commentId) =>
      _socialService.deleteComment(postId, commentId);
  ...
  Future<dynamic> savePloggingTemp({
    ...
    String? mapImagePath,
  }) => _ploggingService.savePloggingTemp(
    requestData: requestData,
    beforeImagePath: beforeImagePath,
    afterImagePath: afterImagePath,
    mapImagePath: mapImagePath,
